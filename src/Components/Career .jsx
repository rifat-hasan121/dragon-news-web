...
const Career = () => {
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <h1 data-aos="zoom-in" className="text-3xl font-bold text-gray-800 mb-4">
        Careers at The Dragon News
      </h1>
      <p data-aos="zoom-in" className="text-gray-600 text-lg">
      ...
      <p data-aos="zoom-in" className="text-gray-600 mt-4 text-lg">
