...
const LatestNews = () => {
  return (
    <div
      data-aos="fade-right"
      className="flex items-center bg-base-200 lg:gap-4 p-2 lg:p-4 my-7"
    >
      <p className="text-white px-4 py-1 lg:py-3 bg-secondary">Latest</p>
      <Marquee
        className="flex gap-3 lg:gap-5 text-red-400"
        pauseOnHover={true}
        speed={60}
      >
        ...
        <p className="font-semibold ml-5">
          " Vietnam Marks 50 Years Since End of War with Nationwide
          Celebrations"
        </p>
        <p className="font-semibold ml-5">
          " Massive Blackout Hits Iberian Peninsula, Leaves Millions Without
          Power"
        </p>
      </Marquee>
    </div>
